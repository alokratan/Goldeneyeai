        ...
        <View style={styles.container}>
            ...
            <View style={styles.itemcont}>
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        return <View style={styles.flatliss}><Pressable onPress={() => like(item)} backgroundColor={item.selected ?  "#0002":"#FFC72C" } style={[styles.itempress]}>
                            <Text style={styles.txtit}>{item.itemname}</Text><AntDesign name="checkcircle" size={item.selected ? 24 : 20} color={item.selected ?  "#0004":"green" } />
                        </Pressable></View>
                    }}
                />
            </View>
